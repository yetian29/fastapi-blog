...
from tests.mocks.user.services import DummyCodeService, DummyLoginService, DummySendService, DummyUserService
...
def mock_test_container() -> punq.Container:
    ...
    # user
    container.register(ICodeService, DummyCodeService)
